...
export class ArlasWuiComponent implements OnInit, AfterViewInit {
  ...
  public constructor(
    ...
    public dialogRefOpenListConfig: MatDialogRef<CustomConfigListComponent>,
    ...
    if (this.arlasStartUpService.shouldRunApp && !this.arlasStartUpService.emptyMode) {
      ...
      this.customListService.redrawList.subscribe(() => this.adjustMapOffset());
    } else {
    ...
    if (this.arlasStartUpService.shouldRunApp && !this.arlasStartUpService.emptyMode) {
      ...
      if (this.resultlistContributors.length > 0) {
        ...
        if (this.userPreferencesService.isLoaded) {
          ...
          this.customListService.rightListContributors = this.rightListContributors;
  ...
  public openListConfig() {
    this.dialogRefOpenListConfig = this.dialog.open(CustomConfigListComponent, {
      disableClose: false,
      width:'600px'
    });
    this.dialogRefOpenListConfig.componentInstance.dashboardId = this.route.snapshot.queryParamMap.get('config_id');
    this.dialogRefOpenListConfig.componentInstance.clickOnNewConfig.subscribe(() => {
