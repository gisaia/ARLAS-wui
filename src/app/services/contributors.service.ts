...
export class ContributorService {
  ...
  public getChipSearchContributor(): ChipsSearchContributor {
    const searchContributorConfig = this.getContributorConfig(this.CHIPSSEARCH_ID);
    let chipsSearchContributor;
    if (searchContributorConfig !== undefined) {
      ...
      this.contributorsIcons.set(this.CHIPSSEARCH_ID, searchContributorConfig.icon);
    }
