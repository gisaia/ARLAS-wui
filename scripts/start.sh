...
SETTINGS_VARS="ARLAS_SERVER_URL 
    ...
    ARLAS_TAGGER_URL 
    ARLAS_MAP_STYLE 
    ARLAS_GOOGLE_ANALYTICS_KEY 
    ARLAS_TICKETING_KEY 
    ARLAS_TAB_NAME 
    RESULTLIST_ENABLE_EXPORT 
    RESULTLIST_EXPORT_SIZE 
    ARLAS_HISTOGRAMS_MAX_BUCKETS 
    ...
    ARLAS_AUTHENT_SCOPE ARLAS_AUTHENT_TOKEN_ENDPOINT 
    ...
    ARLAS_AUTHENT_CLEAR_HASH ARLAS_AUTHENT_STORAGE 
    ...
    ARLAS_WUI_DASHBOARDS_SHORTCUT 
    ARLAS_GEOCODING_ENABLED 
...
INDEX_VARS="ARLAS_GOOGLE_ANALYTICS_KEY 
    ARLAS_TICKETING_KEY 
    ARLAS_WUI_BASE_HREF"
